"""testing_mobile_app_18878 URL Configuration
...
admin.site.site_header = "Testing-Mobile-App"
admin.site.site_title = "Testing-Mobile-App Admin Portal"
admin.site.index_title = "Testing-Mobile-App Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Testing-Mobile-App API",
        default_version="v1",
        description="API documentation for Testing-Mobile-App App",
    ),
    public=True,
